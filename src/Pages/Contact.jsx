            ...
            <div className='flex justify-between' data-aos="fade-up" data-aos-delay="500">
                <div className=''>
                    ...
                    <div className='flex  space-x-5'>
                        ...
                        <a href="https://www.instagram.com/spicysizzlingcakes" target='_blank' rel='noreferrer' className='border p-3 rounded-full border-orangeColor text-orangeColor hover:bg-orangeColor hover:text-white text-xl'> <BsInstagram /></a>
                    </div>
                </div>
